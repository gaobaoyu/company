...
public class MailUitls {
	public static void sendMail(String to){
		...
		try {
			...
			// 设置邮件正文:
			message.setContent("<h1>激活邮件!点下面链接完成激活操作!</h1><h3><a href='http://localhost:8080/user/active.htm'>http://localhost:8080/user/active.htm</a></h3>", "text/html;charset=UTF-8");
			// 3.发送邮件:
