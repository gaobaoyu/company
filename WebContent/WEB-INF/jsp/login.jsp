...
<div id="head"></div>
<div id="middle">
<form id="formd" action="${pageContext.request.contextPath }/user/login.htm" method="post">
<ul style="text-align: center;">
<li style="font-size: 48px">畅享物联网平台</li>

<li><input class="name" name="name" placeholder="请输入用户名"></li>
...
function pleaseUser(){
  window.open("${pageContext.request.contextPath}/user/registerPage.htm");
}
